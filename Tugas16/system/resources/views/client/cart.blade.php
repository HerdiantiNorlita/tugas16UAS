              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <img src="{{url('public')}}/app/images/slider-img1.jpg" alt="" width="20%">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Gucci</h2>
                    </td>
                    <td>RP.100.000</td>
                    <td>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                    <img src="{{url('public')}}/app/images/b1.png" alt="Images" width="20%">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Buccheri</h2>
                    </td>
                    <td>RP.200.000</td>
                    <td>
              ...
              <div class="col-md-7">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black">RP. 300.000</strong>
                  </div>
                </div>
                <div class="row mb-5">
                  <div class="col-md-6">
