              ...
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      <tr>
                        <td>Gucci <strong class="mx-2">x</strong> 1</td>
                        <td>RP.100.000</td>
                      </tr>
                      <tr>
                        <td>Buccheri<strong class="mx-2">x</strong>   1</td>
                        <td>RP.200.000</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td class="text-black font-weight-bold"><strong>RP.300.000</strong></td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <div class="form-group">
                    ...
                    <button class="btn btn-primary btn-lg btn-block"></span> </span> <strong class="text-black"><a href="{{ url('/') }}"> Send </a> </strong></button>
                  </div>
